...
async function seed() {
  try {
    ...
    const users = await User.bulkCreate([
      { username: "Ludivine", email: "ludivine@test.com", password: "password123" },
    ...
    const authors = await Author.bulkCreate([
      ...
      { name: "Tolkien", firstname: "J.R.R.", bio: "Auteur du Seigneur des Anneaux" }
    ], { ignoreDuplicates: true });
    ...
    const series = await Serie.bulkCreate([
      { title: "Harry Potter", description: "Saga magique", type: "novel", total_volumes: 7 },
      { title: "Le Seigneur des Anneaux", description: "Épopée fantastique", type: "novel", total_volumes: 3 }
    ], { ignoreDuplicates: true });

    // ---- BOOKS ----
    const books = await Book.bulkCreate([
      { googleBooksId: "1HP", title: "Harry Potter à l'école des sorciers", cover: "hp1.jpg", serieId: 1 },
      { googleBooksId: "2HP", title: "Harry Potter et la Chambre des Secrets", cover: "hp2.jpg", serieId: 1 },
      { googleBooksId: "1LOTR", title: "La Communauté de l'Anneau", cover: "lotr1.jpg", serieId: 2 }
    ], { ignoreDuplicates: true });
